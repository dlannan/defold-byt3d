...
local mm = require("byt3d/scripts/states/common/mesh-manager")
SGOmanager.MgrMesh      = mm
local am = require("byt3d/scripts/states/common/anim-manager")
SGOmanager.MgrAnim      = am
local pm = require("byt3d/scripts/states/common/physics-manager")
SGOmanager.MgrPhysics   = pm
local cm = require("byt3d/scripts/states/common/camera-manager")
SGOmanager.MgrCameras   = cm
local lm = require("byt3d/scripts/states/common/light-manager")
SGOmanager.MgrLights    = lm
local em = require("byt3d/scripts/states/common/emitter-manager")
SGOmanager.MgrEmitters  = em
local sm = require("byt3d/scripts/states/common/sound-manager")
SGOmanager.MgrSounds    = sm
local tm = require("byt3d/scripts/states/common/control-manager")
SGOmanager.MgrControls  = tm
local gm = require("byt3d/scripts/states/common/gui-manager")
